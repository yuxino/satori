...
一个面向 macOS 和 Windows 11 的本地优先 PDF 学习应用。向 AI 询问当前页或框选区域，对照原文看解释。阅读进度和问答按书保存在本机，下次打开接着读。
...
Satori 支持 Windows 11 x64 与 ARM64，以及 Apple 芯片上的 macOS 14+。Satori 3.4.6 请从 [GitHub Releases](https://github.com/yuxino/satori/releases/latest) 下载。
