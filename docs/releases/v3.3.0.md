...
这一版重新整理了 Satori 的首页，让它更像一张安静、克制的私人阅读车票，同时清掉了会误导后续开发的旧代码与设计文档。

## 主要变化

- 全新 `READING PASS` 首页：深色外框、纸张质感、双线票框和克制的暖金细节形成更完整的黑白视觉层次。
- 首页信息重新编排：当前阅读、阅读进度、年度学习格子、书架和最近弄懂的内容仍在一页内，但主次和操作入口更清楚。
...
- SHA-256：`036341286aa4121c33a8e2e2d61a165564482eedc82b0b35879f6d44912bdd5a`
...
Satori 3.3.0 introduces a monochrome Reading Pass home, refines the mascot emblem, and removes superseded plans and unused packaging assets without changing user data.
