...
日期：2026-08-30 · 状态：已由 ADR 0019 取代

本记录保留 3.4.3 及更早版本由主机手动提升 Windows artifact 的历史边界。3.4.4 起，手动 Windows 工作流仍不发布，但 updater Release 通过 ADR 0019 的显式发布工作流统一验证并提升。
