# satori interface demonstration

The animated preview and MP4 show interactions with the actual production frontend at `f31740ce5f7f722f1adffc52ce12d08c3e05b7f6`. The recording uses original sample documents and documentation-only substitutes for native API boundaries, not a native macOS/Windows session.

**Scope:** PDF reading UI · original local sample · no AI answers.
