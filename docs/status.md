...
- Conversational scope continuity: terse metadata follow-ups such as “有多少页” inherit the most recent meaningful chapter/range scope, so a student can ask naturally after a chapter overview without being told the current page is the whole chapter.
