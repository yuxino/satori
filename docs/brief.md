...
Build a local-first macOS and Windows reading workspace that helps the learner understand difficult PDF material without turning study into note management. The page stays central; explanations appear only when explicitly requested.
...
- Mobile, browser, or Linux clients
