...
Satori は Windows 11 x64・ARM64 と、Apple シリコン搭載 Mac の macOS 14+ に対応します。Windows 3.4.1 は [GitHub Releases](https://github.com/yuxino/satori/releases/latest)、現在の macOS 版は [3.4.0](https://github.com/yuxino/satori/releases/tag/v3.4.0) からダウンロードできます。
