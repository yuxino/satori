...
Satori supports Windows 11 on x64 and ARM64, and macOS 14+ on Apple silicon. Download Satori 3.4.7 from [GitHub Releases](https://github.com/yuxino/satori/releases/latest).
